...
public class DoublePanelPlace extends Place {
	...
	private static final PanelType defaultEast = PanelType.DATA;
	private static final PanelType defaultWest = PanelType.VIS;
	...
	public static class Tokenizer implements PlaceTokenizer<DoublePanelPlace> {
		...
		public DoublePanelPlace getPlace(String token) {
			...
			return new DoublePanelPlace(
					PanelType.fromString(east),
