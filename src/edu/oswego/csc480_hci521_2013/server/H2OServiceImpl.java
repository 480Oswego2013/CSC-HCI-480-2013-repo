...
public class H2OServiceImpl extends RemoteServiceServlet implements H2OService {
    ...
    public List<String> getParsedDataKeys() throws Exception {
        ...
        StoreView val = rest.get(new StoreViewBuilder().setFilter(".hex").setView(1024), StoreView.class);
    ...
    public StoreView getDataStores(StoreViewBuilder builder) throws Exception {
        return rest.get(builder, StoreView.class);
    }

    public Inspect getData(InspectBuilder builder) throws Exception {
        return rest.get(builder, Inspect.class);
    }

    public RFTreeView getTreeView(RFTreeViewBuilder builder) throws Exception {
